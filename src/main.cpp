    ...
    if (!config.cliRenderingEnabled) {
        ...
        while (!window.shouldClose()) {
            ...
            if (ImGui::CollapsingHeader("Features", ImGuiTreeNodeFlags_DefaultOpen)) {
                ...
                ImGui::Checkbox("BVHTraversalDebug", &config.features.enableBVHDebug);
            ...
            if (ImGui::CollapsingHeader("Extra Features")) {
                ...
                ImGui::Checkbox("Bloom:Show Thresholded ", &config.features.extra.enableBloomThreshholded);
                ImGui::Checkbox("Bloom:Show Threshholded Blurred", &config.features.extra.enableBloomThreshBlurred);
                ImGui::Checkbox("Irregular Rays", &config.features.extra.enableMultipleRaysPerPixel);
                ImGui::Checkbox("Irregular Rays: Half Screen", &config.features.extra.enableMultipleRaysPerPixelHalfScreen);
            ...
            if (ImGui::TreeNode("Bloom")) {
                int filter_size;
                ImGui::InputInt("Size (N*N)", &filter_size, ImGuiInputTextFlags_ReadOnly);
                ImGui::TreePop();
            }
            ImGui::Spacing();
            ImGui::Separator();
